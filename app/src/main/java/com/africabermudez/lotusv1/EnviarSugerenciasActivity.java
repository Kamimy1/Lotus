...
public class EnviarSugerenciasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enviar_sugerencias);
        ...
        actionBar.setTitle("Enviar sugerencias");
        if (actionBar != null) {
            actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(enviarasunto.isEmpty() || enviarmensaje.isEmpty()){
                    Toast.makeText(EnviarSugerenciasActivity.this, "Hay campos vacios", Toast.LENGTH_LONG).show();
                }else{
